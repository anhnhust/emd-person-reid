...
def test(model, queryloader, galleryloader, use_gpu, ranks=[1, 5, 10]):
    batch_time = AverageMeter()
    ...
    cmc, mAP = evaluate(distmat, q_pids, g_pids, q_camids, g_camids,_,_, use_metric_cuhk03=args.use_metric_cuhk03)
